    ...
    >
      ...
      >
        <Stack alignItems="flex-start" spacing={5}>
          <Text fontSize="18px" fontWeight="semibold" color="whiteAlpha.800">
            {" "}
            popular Categories
          </Text>
          <SimpleGrid
      ...
      >
        <HStack spacing={5}>
          <Image
            w="25px"
            src="https://www.hotjar.com/images/hotjar-logo-small.svg"
          />
          <Text color="whiteAlpha.800">
            Copyright © 2014 - 2022 Hotjar Ltd. All rights reserved.
          </Text>
        </HStack>
