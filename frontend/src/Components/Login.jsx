...
import { Alert, AlertDescription, AlertIcon, AlertTitle, Box, Button, CloseButton, Flex, Heading, Image, Input, Spinner} from "@chakra-ui/react";
...
function Login() {
  ...
  if (login.error) {
   return <Alert status='error' h="100px" w="450px" ml="510px">
    <AlertIcon />
    <Box>
  ...
  return (
    ...
    backgroundSize= 'cover'
     bgImage="url('https://habitatbroward.org/wp-content/uploads/2020/01/10-Benefits-Showing-Why-Education-Is-Important-to-Our-Society.jpg')">
      ...
      background-clip= 'text'>Admin Login</Heading>
      <Flex mt="250px" flexDirection={'column'} gap="30px"  height="100px" w="500px" ml={'480px'}  justify="center" alignItems={'center'}>
      ...
      {login.loading ? (
        ...
        mt="30px"
        colorScheme={"red"}
          onClick={() => handleClick(login_cred.username, login_cred.password)}
        >
          Login
        </Button>
